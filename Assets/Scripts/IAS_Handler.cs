...
{      
	...
	void OnClick()
	{
		...
		GoogleAnalytics.Instance.LogEvent((backscreen_ad ? "Backscreen " : "") + "IAS Click", "Screen: " + bannerID + ", URL: " + url.Replace("https://play.google.com/store/apps/details?id=", "com.i6.truck_parking_fuel_truck"));
